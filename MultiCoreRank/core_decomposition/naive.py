...
def naive(multilayer_graph, print_file, distinct_flag):
    ...
    # print "des vector " + str(descendant_vector)
    # print "vector queue " + str(vectors_queue)
    # print "computer vector " + str(computed_vectors)
    ...
    while len(vectors_queue) > 0:
        ...
        if len(k_core) > 0:
            ...
            # compute its descendant vectors, add a new potential core to calculate
            for index in multilayer_graph.layers_iterator:
